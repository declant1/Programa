...
if(!$connection) 
        ...
        $instruccion_SQL = "INSERT INTO tabla_form (nombre, apellido,documento,departamento,municipio)
                             VALUES ('$nombre','$apellido','$documento','$departamento','$municipio')";
...
while ($colum = mysqli_fetch_array($result))
 {
    ...
    echo "<td><h2>" . $colum['departamento'] . "</td></h2>";
